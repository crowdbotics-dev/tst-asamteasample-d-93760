...
## Project Structure
    ...
    ├── tst_asamteasample_d_93760  # Django project configurations
...
1. Clone this repo and `cd tst_asamteasample_d_93760`
...
2. Clone this repo and `cd tst_asamteasample_d_93760`
